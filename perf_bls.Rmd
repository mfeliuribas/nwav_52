---
title: "*Bailé* or *he bailado*? Variable Perfective Past Time Reference among Spanish-English Early Bilinguals"
subtitle: "New Ways of Analyzing Variation 52"
...
# Variable Expression of Perfectivity
...
+ .black[Key findings] in previous studies: 
  ...
  + Dialectal differences in the .black[usage rates] 
      + Most of the Spanish varieties &rarr; PRET as the default form &rarr; Lower rates of PPERF (restricted use)
      
      + Peninsular Spanish &rarr; PPERF as the unmarked form in hodiernal ('today') and temporally undetermined contexts
...
<br>
  ...
  + *Key findings (continued)*
    ...
    + Dialectal differences in the <span style="font-weight:bold; color:black;">factors</span> that constrain their uses:
...
---
# Research Questions
.black[1.] What is the frequency of choice of the Spanish preterit and present perfect forms by Spanish-English early bilinguals raised in the United States?

.black[2.] How does family origin condition the selection of the perfective past time paradigms in Spanish?

.black[3.] Is there a relationship between participant verb form choice, family origin, temporal reference, and/or lexical aspect?
...
+ Divided into .black[4 groups], based on the origin of their families:
    1. parent from Spain and the U.S. (n=3) &rarr; <span style="font-weight:bold; color:black;">‘1Spaniard’</span>
    2.  both parents from Spain (n=5) &rarr; <span style="font-weight:bold; color:black;">‘2Spaniards’</span>
    3.  parent from Spain and a Caribbean Spanish-speaking country (n=4) &rarr; <span style="font-weight:bold; color:black;">‘Bidialectal’</span>
    4. parents from other Spanish-speaking countries (n=16) &rarr; <span style="font-weight:bold; color:black;">‘Other’</span>


---
### Materials

1. .black[Sociolinguistic Questionnaire] 

2. .black[Spanish Proficiency Test] (Montrul, 2012)
...
3. .black[Contextualized Preference Task]
  ...
  + Manipulated variables: 
      ...
      + Temporal reference: Prehodiernal - Hodiernal - Undetermined
...
.tg td{border-color:black;border-style:solid;border-width:1px;font-family:"Palatino Linotype", "Book Antiqua", Palatino, serif !important;
  overflow:hidden;padding:10px 5px;word-break:normal;}
.tg th{border-color:black;border-style:solid;border-width:1px;font-family:"Palatino Linotype", "Book Antiqua", Palatino, serif !important;
  font-weight:normal;overflow:hidden;padding:10px 5px;word-break:normal;}
.tg .tg-09u7{background-color:#ffffff;border-color:#ffffff;
  font-family:"Palatino Linotype", "Book Antiqua", Palatino, serif !important;text-align:left;
  vertical-align:top}
</style>
...
- .black[Random slopes]: temporal reference and lexical aspect
...
+ The probability of selection of the PPERF varied as a function of family origin and temporal reference (but not lexical aspect)
...
+ Spanish-English early bilinguals can acquire the distinction between the past perfective time forms in Spanish
    ...
    + Variation akin to monolingual native speakers, especially for those participants with two Spanish-speaking parents (2Spaniards, Other)

???
<br>

+ Limitations and Future steps
    + Add more data to the model + a control group
    
    + Perform all pairwise comparisons
    
    + Examine the effect of other potential extralinguistic variables
...
<p>Montrul, S. (2012). <i>DELE Proficiency Test</i>.</p> 
