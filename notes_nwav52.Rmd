...
Hi, everyone! Thank you so much for coming. I will present to you an exploratory study on the acquisition of the variable perfective past time reference in Spanish among Spanish-English early bilinguals

# Studying Variation on Perfectivity

Since the early 2000s, there has been an increasing interest in variationist sociolinguistics in studying the use of the Spanish perfective past time paradigms by monolinguals from different Spanish-speaking countries, as perfectivity can be expressed using the preterit and the present perfect.
...
The PRET is strongly favored by Other in undetermined and hodiernal contexts, but that there are no differences between 2Spaniards, 1Spaniard and Bidialectal.
